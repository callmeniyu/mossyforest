        ...
        <div className="container-max section-padding">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Walk through ancient moss-covered trees via safe wooden boardwalks
              and discover rare plants, stunning views, and unique wildlife
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg card-shadow overflow-hidden">
              <Image
                ...
                alt="Mossy Forest boardwalk trail"
                width={400}
                height={300}
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Safe wooden boardwalks wind through the forest, offering easy
                  access to all major viewpoints and natural attractions.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg card-shadow overflow-hidden">
              <Image
                src="/images/mossyforest (4).jpg"
                alt="Ancient moss-covered trees in Cameron Highlands"
                width={400}
                height={300}
                className="w-full h-48 object-cover"
              />
              <div className="p-6">
                <h3 className="text-xl font-bold text-forest mb-2">
                  Ancient Moss-Covered Trees
                </h3>
                <p className="text-gray-600">
                  Witness centuries-old trees wrapped in vibrant green moss,
                  creating a magical fairytale-like atmosphere.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg card-shadow overflow-hidden">
              <Image
                src="/images/mossyforest (5).jpg"
                alt="Panoramic highland views from Mossy Forest"
                width={400}
                height={300}
                className="w-full h-48 object-cover"
              />
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  On clear days, enjoy sweeping views of Cameron Highlands and
                  see all the way to Ipoh and beyond.
                </p>
              </div>
            </div>
          </div>
