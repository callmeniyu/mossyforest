...
export const metadata = {
  title: "Mossy Forest — Cameron Highlands | Mossy Forest Malaysia, Brinchang",
  description:
    "Discover Mossy Forest in Cameron Highlands — location, entrance, tours, and visitor tips. Info about Mossy Forest Malaysia, Brinchang, guided eco tours, parking, and what to wear.",
  keywords: [
    ...
    "BOH Tea Plantation tour Mossy Forest",
  ...
  openGraph: {
    ...
    description:
      "Visit Mossy Forest in Cameron Highlands. Practical info on location, tours, prices, parking, and guided eco experiences.",
    url: "https://www.oastel.com/tours/mossy-forest",
    siteName: "Oastel — Mossy Forest",
    images: [
      {
        url: "https://www.oastel.com/images/hero.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Mossy Forest — Cameron Highlands",
    description:
      "Visitor info, tours and tips for Mossy Forest, Brinchang, Cameron Highlands.",
    images: ["https://www.oastel.com/images/hero.jpg"],
  },
};
...
export default function MossyForestPage() {
  return (
    <>
      {/* JSON-LD structured data for SEO (TouristAttraction + Breadcrumb) */}
      <script
            ...
            "@graph": [
              {
                ...
                "@id": "https://www.oastel.com/tours/mossy-forest",
                name: "Mossy Forest Eco Park",
                description:
                  "Mossy Forest in Cameron Highlands: an ancient montane ecosystem at about 2,000 meters, offering guided eco tours, nature trails, and photography spots.",
                image: "https://www.oastel.com/images/hero.jpg",
                address: {
                  "@type": "PostalAddress",
                  addressLocality: "Brinchang",
                ...
                containsPlace: [
                  {
                    "@type": "Place",
                    name: "Gunung Brinchang viewpoint",
                  },
                  {
                    "@type": "Place",
                ...
                itemListElement: [
                  {
                    ...
                    position: 1,
                    name: "Home",
                    item: "https://www.oastel.com/",
                  },
                  {
                    "@type": "ListItem",
                    position: 2,
                    name: "Tours",
                    item: "https://www.oastel.com/tours",
                  },
                  {
                    "@type": "ListItem",
                    position: 3,
                    name: "Mossy Forest",
                    item: "https://www.oastel.com/tours/mossy-forest",
                  },
                ],
              },
            ],
          ...
          <div className="relative z-10 flex items-center justify-center h-full">
            <div className="text-center text-white section-padding">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <a
                  href="https://www.oastel.com/tours"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-secondary btn-attention inline-flex items-center space-x-2"
                >
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <p className="text-gray-700">
                      <strong>Bring a jacket</strong> - The weather can be
                      chilly and damp throughout the day.
                    </p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                    <p className="text-gray-700">
                      <strong>Visit in the morning</strong> - Clearer weather
                      with less fog for better panoramic views.
                    </p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                    <p className="text-gray-700">
                      <strong>Arrive early</strong> - The forest is very
                      popular, so early arrival helps avoid crowds.
                    </p>
                  </div>
                </div>
